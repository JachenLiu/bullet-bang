...
namespace Bang
{
    ...
    {
        private List<UnplayableCard> Roles;

        private List<UnplayableCard> DefaultCharacters;
        private List<UnplayableCard> DodgeCityCharacters;
        private List<UnplayableCard> SpecialCharacters;

        private List<PlayableCard> DefaultPlayingCards;
        private List<PlayableCard> DodgeCityCards;

        private List<PlayableCard> FistfulOfCards;
        private List<PlayableCard> HighNoon;
        ...
        public void GenerateDatabase()
        {
            ...
            //Default Characters
            DefaultCharacters = new List<UnplayableCard>();
            ...
            DodgeCityCharacters = new List<UnplayableCard>();
            ...
            //Special Characters
            SpecialCharacters = new List<UnplayableCard>();
            ...
            //Default Game Cards
            DefaultPlayingCards = new List<PlayableCard>();
        ...
        public List<UnplayableCard> GetDefaultCharacters()
        {
            return DefaultCharacters;
        }
        public List<UnplayableCard> GetDodgeCityCharacters()
        {
            return DodgeCityCharacters;
        }
        public List<UnplayableCard> GetSpecialCharacters()
        {
            return SpecialCharacters;
        }
        public List<UnplayableCard> GetDefaultAndDodge()
        {
            List<UnplayableCard> DefaultAndDodge = new List<UnplayableCard>();
        ...
        public List<UnplayableCard> GetDefaultAndSpecial()
        {
            List<UnplayableCard> DefaultAndSpecial = new List<UnplayableCard>();
        ...
        public List<UnplayableCard> GetDefaultAndDodgeAndSpecial()
        {
            List<UnplayableCard> DefaultAndDodgeAndSpecial = new List<UnplayableCard>();
        ...
        public List<PlayableCard> GetDefaultCards()
        {
            return DefaultPlayingCards;
        }
        public List<PlayableCard> GetDodgeCityCards()
        {
